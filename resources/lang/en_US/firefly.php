...
return [
    ...
    'rule_trigger_date_on_day_choice'                     => 'Transaction day of month is..',
    'rule_trigger_date_on_day'                            => 'Transaction day of month is ":trigger_value"',
    'rule_trigger_date_on_month_choice'                   => 'Transaction month is..',
    'rule_trigger_date_on_month'                          => 'Transaction month is ":trigger_value"',
    'rule_trigger_date_on_day_of_week_choice'             => 'Transaction day of week is..',
    'rule_trigger_date_on_day_of_week'                    => 'Transaction day of week is ":trigger_value"',
    ...
    'rule_trigger_interest_date_on_day_choice'            => 'Interest date day of month is..',
    'rule_trigger_interest_date_on_day'                   => 'Interest date day of month is ":trigger_value"',
    'rule_trigger_interest_date_on_month_choice'          => 'Interest date month is..',
    'rule_trigger_interest_date_on_month'                 => 'Interest date month is ":trigger_value"',
    'rule_trigger_interest_date_on_day_of_week_choice'    => 'Interest date day of week is..',
    'rule_trigger_interest_date_on_day_of_week'           => 'Interest date day of week is ":trigger_value"',
    ...
    'rule_trigger_book_date_on_day_choice'                => 'Book date day of month is..',
    'rule_trigger_book_date_on_day'                       => 'Book date day of month is ":trigger_value"',
    'rule_trigger_book_date_on_month_choice'              => 'Book date month is..',
    'rule_trigger_book_date_on_month'                     => 'Book date month is ":trigger_value"',
    'rule_trigger_book_date_on_day_of_week_choice'        => 'Book date day of week is..',
    'rule_trigger_book_date_on_day_of_week'               => 'Book date day of week is ":trigger_value"',
    ...
    'rule_trigger_process_date_on_day_choice'             => 'Process date day of month is..',
    'rule_trigger_process_date_on_day'                    => 'Process date day of month is ":trigger_value"',
    'rule_trigger_process_date_on_month_choice'           => 'Process date month is..',
    'rule_trigger_process_date_on_month'                  => 'Process date month is ":trigger_value"',
    'rule_trigger_process_date_on_day_of_week_choice'     => 'Process date day of week is..',
    'rule_trigger_process_date_on_day_of_week'            => 'Process date day of week is ":trigger_value"',
    ...
    'rule_trigger_due_date_on_day_choice'                 => 'Due date day of month is..',
    'rule_trigger_due_date_on_day'                        => 'Due date day of month is ":trigger_value"',
    'rule_trigger_due_date_on_month_choice'               => 'Due date month is..',
    'rule_trigger_due_date_on_month'                      => 'Due date month is ":trigger_value"',
    'rule_trigger_due_date_on_day_of_week_choice'         => 'Due date day of week is..',
    'rule_trigger_due_date_on_day_of_week'                => 'Due date day of week is ":trigger_value"',
    ...
    'rule_trigger_payment_date_on_day_choice'             => 'Payment date day of month is..',
    'rule_trigger_payment_date_on_day'                    => 'Payment date day of month is ":trigger_value"',
    'rule_trigger_payment_date_on_month_choice'           => 'Payment date month is..',
    'rule_trigger_payment_date_on_month'                  => 'Payment date month is ":trigger_value"',
    'rule_trigger_payment_date_on_day_of_week_choice'     => 'Payment date day of week is..',
    'rule_trigger_payment_date_on_day_of_week'            => 'Payment date day of week is ":trigger_value"',
    ...
    'rule_trigger_invoice_date_on_day_choice'             => 'Invoice date day of month is..',
    'rule_trigger_invoice_date_on_day'                    => 'Invoice date day of month is ":trigger_value"',
    'rule_trigger_invoice_date_on_month_choice'           => 'Invoice date month is..',
    'rule_trigger_invoice_date_on_month'                  => 'Invoice date month is ":trigger_value"',
    'rule_trigger_invoice_date_on_day_of_week_choice'     => 'Invoice date day of week is..',
    'rule_trigger_invoice_date_on_day_of_week'            => 'Invoice date day of week is ":trigger_value"',
    ...
    'rule_trigger_created_at_on_day_choice'               => 'Transaction created day of month is..',
    'rule_trigger_created_at_on_day'                      => 'Transaction created day of month is ":trigger_value"',
    'rule_trigger_created_at_on_month_choice'             => 'Transaction created month is..',
    'rule_trigger_created_at_on_month'                    => 'Transaction created month is ":trigger_value"',
    'rule_trigger_created_at_on_day_of_week_choice'       => 'Transaction created day of week is..',
    'rule_trigger_created_at_on_day_of_week'              => 'Transaction created day of week is ":trigger_value"',
    ...
    'rule_trigger_updated_at_on_day_choice'               => 'Transaction updated day of month is..',
    'rule_trigger_updated_at_on_day'                      => 'Transaction updated day of month is ":trigger_value"',
    'rule_trigger_updated_at_on_month_choice'             => 'Transaction updated month is..',
    'rule_trigger_updated_at_on_month'                    => 'Transaction updated month is ":trigger_value"',
    'rule_trigger_updated_at_on_day_of_week_choice'       => 'Transaction updated day of week is..',
    'rule_trigger_updated_at_on_day_of_week'              => 'Transaction updated day of week is ":trigger_value"',
    ...
    'backup_download_expl'                                => 'Create a full backup of your database and all attachment files. The backup is a portable .tar.gz archive that can be restored on any Firefly III instance running PostgreSQL.',
    'backup_download_button'                              => 'Download full backup',
    'backup_download_note'                                => 'This may take a while for large databases. The download will start automatically when the backup is ready.',
    'backup_restore_title'                                => 'Restore from Backup',
    'backup_restore_warning_title'                        => 'Warning: destructive operation',
    'backup_restore_warning'                              => 'Restoring a backup will REPLACE ALL DATA in the current database. You will be logged out after the restore completes. This action cannot be undone.',
    'backup_restore_select_file'                          => 'Select a backup archive (.tar.gz)',
    'backup_restore_button'                               => 'Restore backup',
    'backup_restore_confirm'                              => 'This will REPLACE ALL DATA in the current database. Are you sure you want to continue?',
    'backup_restore_success'                              => 'Backup restored successfully. Please log in.',
    'backup_cli_title'                                    => 'Command line',
    'backup_cli_expl'                                     => 'You can also create and restore backups from the command line:',
    'backup_only_postgresql'                              => 'Backup and restore only supports PostgreSQL. Your current database connection is not PostgreSQL.',
    'backup_pg_dump_not_found'                            => 'The pg_dump binary was not found on this system. Install PostgreSQL client tools to enable backups.',
    'backup_psql_not_found'                               => 'The psql binary was not found on this system. Install PostgreSQL client tools to enable restores.',
    'backup_pg_dump_failed'                               => 'Database backup failed. Check the application logs for details.',
    'backup_psql_failed'                                  => 'Database restore failed. Check the application logs for details.',
    'backup_temp_dir_failed'                              => 'Could not create a temporary directory for the backup.',
    'backup_archive_failed'                               => 'Could not create the backup archive. Check the application logs for details.',
    'backup_extract_failed'                               => 'Could not extract the backup archive. Make sure it is a valid .tar.gz file.',
    'backup_invalid_archive'                              => 'Invalid backup archive: required files (manifest.json, database.sql) not found.',
    'backup_no_file'                                      => 'Please select a valid backup file to upload.',
    'demo_user_no_backup'                                 => 'Demo users cannot create or restore backups.',

    // Google Drive cloud sync:
    'gdrive_setup_title'                                  => 'Google Drive',
    'gdrive_status_connected'                             => 'Connected',
    'gdrive_setup_needed_title'                           => 'Google Drive not configured',
    'gdrive_setup_needed_expl'                            => 'To enable cloud backups, you need to set up Google Drive API credentials:',
    'gdrive_setup_step1'                                  => 'Go to Google Cloud Console > APIs & Services > Credentials.',
    'gdrive_setup_step2'                                  => 'Create an OAuth 2.0 Client ID (Web application type).',
    'gdrive_setup_step3'                                  => 'Add your redirect URI: <your-app-url>/backup/google-drive/callback',
    'gdrive_setup_step4'                                  => 'Set GOOGLE_DRIVE_CLIENT_ID and GOOGLE_DRIVE_CLIENT_SECRET in your .env file.',
    'gdrive_connect_expl'                                 => 'Google Drive credentials are configured. Click below to authorize Firefly III to access your Google Drive.',
    'gdrive_connect_button'                               => 'Connect to Google Drive',
    'gdrive_connected_expl'                               => 'Firefly III is connected to your Google Drive. Backups and budget plans can be synced to the cloud.',
    'gdrive_disconnect_button'                            => 'Disconnect',
    'gdrive_disconnect_confirm'                           => 'Are you sure you want to disconnect Google Drive?',
    'gdrive_not_configured'                               => 'Google Drive is not configured. Set GOOGLE_DRIVE_CLIENT_ID and GOOGLE_DRIVE_CLIENT_SECRET in your .env file.',
    'gdrive_not_connected'                                => 'Google Drive is not connected. Please authorize first via the Backup page.',
    'gdrive_auth_failed'                                  => 'Google Drive authorization failed. Please try again.',
    'gdrive_connected'                                    => 'Successfully connected to Google Drive!',
    'gdrive_disconnected'                                 => 'Google Drive has been disconnected.',
    'gdrive_backup_title'                                 => 'Backup to Google Drive',
    'gdrive_backup_expl'                                  => 'Create a full backup and upload it to your Google Drive.',
    'gdrive_backup_button'                                => 'Backup to Google Drive',
    'gdrive_backup_success'                               => 'Backup successfully uploaded to Google Drive!',
    'gdrive_backup_failed'                                => 'Failed to upload backup to Google Drive. Check the application logs.',
    'gdrive_restore_title'                                => 'Restore from Google Drive',
    'gdrive_loading_files'                                => 'Loading backups from Google Drive...',
    'gdrive_no_backups'                                   => 'No backups found on Google Drive.',
    'gdrive_file_name'                                    => 'Filename',
    'gdrive_file_date'                                    => 'Date',
    'gdrive_file_size'                                    => 'Size',
    'gdrive_file_actions'                                 => 'Actions',
    'gdrive_restore_confirm'                              => 'This will REPLACE ALL DATA in the current database with the selected cloud backup. Are you sure?',
    'gdrive_restore_btn'                                  => 'Restore',
    'gdrive_restore_failed'                               => 'Failed to restore from Google Drive. Check the application logs.',
    'gdrive_delete_confirm'                               => 'Are you sure you want to delete this backup from Google Drive?',
    'gdrive_delete_btn'                                   => 'Delete',
    'gdrive_delete_success'                               => 'Backup deleted from Google Drive.',
    'gdrive_delete_failed'                                => 'Failed to delete backup from Google Drive.',
    'gdrive_no_file_selected'                             => 'No file was selected.',
    'gdrive_load_error'                                   => 'Could not load backups from Google Drive.',
    'gdrive_plans_title'                                  => 'Budget Plans Sync',
    'gdrive_plans_expl'                                   => 'Sync your budget plan files between this Firefly III instance and Google Drive.',
    'gdrive_plans_local_count'                            => ':count budget plan(s) on this server.',
    'gdrive_push_plans_button'                            => 'Push to Cloud',
    'gdrive_pull_plans_button'                            => 'Pull from Cloud',
    'gdrive_pull_plans_confirm'                           => 'This will overwrite local budget plan files with versions from Google Drive. Continue?',
    'gdrive_pull_plans_warning'                           => 'Pulling from cloud will overwrite any local budget plan files that have the same filename.',
    'gdrive_push_plans_success'                           => 'Pushed :count budget plan(s) to Google Drive.',
    'gdrive_push_plans_failed'                            => 'Failed to push budget plans to Google Drive. Check the application logs.',
    'gdrive_pull_plans_success'                           => 'Pulled :count budget plan(s) from Google Drive.',
    'gdrive_pull_plans_failed'                            => 'Failed to pull budget plans from Google Drive. Check the application logs.',
